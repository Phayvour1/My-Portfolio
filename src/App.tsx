...
import { BrowserRouter as Router, Route, Routes } from "react-router-dom"; // Updated to `Routes` for React Router v6+

// Animation variants for wobble and hover effects
